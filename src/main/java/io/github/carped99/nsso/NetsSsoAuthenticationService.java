...
public interface NetsSsoAuthenticationService {
     ...
     */
    default Authentication authenticate(NetsSsoAuthentication authentication) throws AuthenticationException {
        return authenticate(authentication.getRequest(), authentication.getResponse());
    }
